...
public class DrawP extends JPanel {
...
//    	    getParent().doLayout();
      ...
      //  double d = (double) n * 1.08;
       // d = (n > 0) ? 1 / d : -d;
        ...
        int w = (int) (getWidth() * n);
        int h = (int) (getHeight() * n);
        preferredSize.setSize(w, h);

        int offX = (int)(p.x * n) - p.x;
        int offY = (int)(p.y * n) - p.y;
...
//        SnaptoGrid snap1 = new SnaptoGrid(npx-4, npy-4, result);
//        //
//        						snap1.snap();
//        						result=false;
   }
